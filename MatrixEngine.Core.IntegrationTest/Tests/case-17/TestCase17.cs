...
[Order(3)]
public class TestCase17 : TestBed<IntegrationTestFixture>
{
    public TestCase17(ITestOutputHelper testOutputHelper, IntegrationTestFixture fixture) : base(testOutputHelper,
        fixture)
    {
    }
    ...
    {
        // This test case will perform multiple bonded, unbonded and withdrawn events,
        // lowering the max effective balance AND max unlocking balance
        // twice in one reward cycle. The effective balances for bonded and unlocking should be:
        // block range       bonded eff bal      unlocking eff bal
        // 0  - 9              600                     0
        // 10 - 19             600                     700
        // 20 - 29             1000                    700
        // 30 - 39             1000                    700
        ...
        await dataLoader?.LoadCase("case-17")!;
